export const placesData = [
  ...
  },
  {
    ...
    region: 'North',
    story: {
      what: "Vrindavan is a sacred forest town where Lord Krishna is believed to have spent his childhood. It is a city of over 5,000 temples, where the atmosphere is perpetually thick with the scent of incense and the sound of 'Radha Radha'.",
...
export const getEnhancedPlaceData = (placeId) => {
  return placesData.find(p => p.id === placeId) || {};
};

export const buildPlaceContext = (place) => {
  if (!place?.id) {
    return [
